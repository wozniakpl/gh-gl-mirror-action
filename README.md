...
- uses: wozniakpl/gh-gl-mirror-action@v1
  with:
    ...
    visibility: 'private'          # public | private | internal | keep
...
| `visibility` | Yes | New GitLab project visibility: `public`, `private`, `internal`, or `keep` (preserve source repo visibility) |
